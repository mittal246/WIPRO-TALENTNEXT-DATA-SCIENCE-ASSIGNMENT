...
print("First 10 rows of cars DataFrame:")
print(cars.head(10))


print("\nFull cars DataFrame:")
print(cars)
print("\nLast 5 rows of cars DataFrame:")
print(cars.tail(5))


print("\nMeta Information of cars DataFrame:")
print(cars.info())


#4. Download 50_startups dataset
...
print("\nStatistical Summary of 50_startups DataFrame:")
